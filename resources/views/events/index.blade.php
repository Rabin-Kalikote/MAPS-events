...
@extends('layouts.app')
@section('content')
<div class="container py-4" style="background:#f8f9fb;">
    <h1 class="mb-4 text-center fw-bold" style="color:#533860;letter-spacing:1px;">MAPS Events</h1>
    <ul class="nav nav-tabs justify-content-center mb-4" id="eventTabs" role="tablist" style="border-bottom:1px solid #dee2e6;">
